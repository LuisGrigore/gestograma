...
var _word_row_models:Array[TileRowModel] = []
...
static func init(target_word:String, max_tries:int) -> WordGridModel:
	...
	for i in max_tries:
		word_grid_model._word_row_models.append(TileRowModel.init(target_word))
	return word_grid_model

func get_word_row_models() -> Array[TileRowModel]:
